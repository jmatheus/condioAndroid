...
public class ListContentFragment extends Fragment {
    ...
    public static class ContentAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        private final String[] mOrdersDetail;
        private final Drawable[] mPlaceAvators;

        public ContentAdapter(Context context) {
            Resources resources = context.getResources();
            mOrders = resources.getStringArray(R.array.orders);
            mOrdersDetail = resources.getStringArray(R.array.orders_detail);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.name.setText(mOrders[position % mOrders.length]);
            holder.description.setText(mOrdersDetail[position % mOrdersDetail.length]);
        }
